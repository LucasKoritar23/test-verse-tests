        ...
        stage('Running Tests') {
            steps {
                script {
                    ...
                    def dockerBuildCommand = "docker run -e DB_USER=$DB_USER -e DB_HOST=$DB_HOST -e DB_DATABASE=$DB_DATABASE -e DB_PASSWORD=$DB_PASSWORD -e DB_PORT=$DB_PORT -e URI_API=$URI_API -t --rm $DOCKERHUB_USERNAME/test-verse-tests:${params.image_test}"
